                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="w-100 list-unstyled d-flex justify-content-between mb-0 text-green">
                                <li>Envío gratis</li>
                            </ul>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    ...
                                    <p class="text-dark"><strong><?php echo $data['producto']['categoria'] ?></strong></p>
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-center mb-0">$<?php echo $relacion['precio']; ?></p>
                        </div>
                    </div>
                </div>
